...
#define CPPTEMPLATE_STR_IMPL(x, y) x##y
#define CPPTEMPLATE_STR(x, y)      CPPTEMPLATE_STR_IMPL(x, y)

#if CPPTEMPLATE_WITH_SCOPED_PROFILER
    #define CPPTEMPLATE_SCOPED_PROFILER(x) const utils::ScopedProfiler CPPTEMPLATE_STR(_SCOPED_PROFILER_, __LINE__)(x)
#else
