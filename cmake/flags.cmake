...
if (CMAKE_BUILD_TYPE STREQUAL Debug OR ${${PROJECT_PREFIX}_WITH_SCOPE_PROFILER})
    add_compile_definitions(UTILS_WITH_SCOPE_PROFILER=1)
else ()
    add_compile_definitions(UTILS_WITH_SCOPE_PROFILER=0)
endif ()
